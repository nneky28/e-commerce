...
function ListFrame({ picture, name, price, sliced, product,id }) {
    ...
    return (
			...
			<div className="list mb-3 px-2">
				...
				<h4 className="card-title mt-5 ms-3">{name}
			 		...
			 		<span className="sm-circle bg-primary" style={{ marginLeft: '5px' }}  >	</span>						
				</h4>
				...
				<div className="prices ms-3">
								...
								<i className="fas fa-cart-plus item-actions p-3"  onClick={()=>addItem(product)}/>
